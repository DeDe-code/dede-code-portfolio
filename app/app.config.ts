export default defineAppConfig({
  ui: {
    ...
    contentSideMenu: {
      slots: {
        root: "sticky top-[var(--min-height-app-header)] overflow-hidden min-h-[calc(100vh_-_var(--min-height-app-header)_-_var(--min-height-app-footer))] flex flex-col items-center justify-center p-0 uppercase lg:w-[30.5%] lg:flex-shrink-0 lg:hidden lg:px-spacing-200 lg:pt-spacing-200 lg:px-spacing-200 lg:border-r-4 border-black",
